...
var varCaller, varFunc = caller(0) //nolint: gochecknoglobals
...
func TestCaller(t *testing.T) {
	...
	t.Run("when called in a function", func(t *testing.T) {
		...
		require.Equal(t, "github.com/safeblock-dev/werr/caller_test.go:9", sourceCaller)
	...
	t.Run("when called from outside", func(t *testing.T) {
		...
		require.Equal(t, "github.com/safeblock-dev/werr/caller_test.go:13", varCaller)
